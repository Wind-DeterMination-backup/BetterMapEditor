...
final class GithubUpdateCheck {
    ...
    private static final String repo = "BetterMapEditor";
    private static final String modName = "bettermapeditor";

    private static final String keyUpdateCheckEnabled = "bme-updatecheck";
    private static final String keyUpdateCheckShowDialog = "bme-updatecheck-dialog";
    private static final String keyUpdateCheckLastAt = "bme-updatecheck-lastAt";
    private static final String keyUpdateCheckIgnoreVersion = "bme-updatecheck-ignore";
